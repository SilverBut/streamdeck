...
type attributeCollection struct {
	...
	CaptionWithoutTrim bool              `json:"caption_without_trim,omitempty" yaml:"caption_without_trim,omitempty"`
	...
	TextWithoutTrim    bool              `json:"text_without_trim,omitempty" yaml:"text_without_trim,omitempty"`
